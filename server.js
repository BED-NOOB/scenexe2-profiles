...
app.get("/account/:user", async (req, res) => {
	...
	try {
        ...
        const polygonGalleryImages = [
            ...
            "https://media.discordapp.net/attachments/1016463628813213838/1233008281388318841/GuaSwwbqpkmtMt5NyBweN3xqvfpFFZdxqOVw9fNDTojuiUNJEx.png?ex=662cd972&is=662b87f2&hm=57b78e8c6feb71fc55d8cf2e2e6b16be46de6739e5b47b74c629fcacd325951c&=&format=webp&quality=lossless",
            "https://media.discordapp.net/attachments/1016463628813213838/1233008414473457675/QnPUsfZZdCBCdH4nU0oKOiWrGTtFswhXQQNkrU3urnfOPWlBL7.png?ex=662cd992&is=662b8812&hm=fccac7761a111a2db22002abc3da04104b165e7209a5003b0c4d72e2b22ec188&=&format=webp&quality=lossless",
            "https://media.discordapp.net/attachments/1016463628813213838/1233008604320370698/zSwluTn3ru5y05nW1bae0LrasOSqk2PQHotg6Jnge1W3xDUQS2.png?ex=662cd9bf&is=662b883f&hm=496367f86d0edf3e564d412b867c668cc5a6ac1f35afb96ea600e2e1012c7f5f&=&format=webp&quality=lossless",
            "https://media.discordapp.net/attachments/1016463628813213838/1233008822508060802/I7pK1TN4HdcgefSCh2kyq44VqaDm1jmubcs0Cw22QwlDulu0mi.png?ex=662cd9f3&is=662b8873&hm=525620d52907e2bda5fb0ddfaccc0736973f5912601b1b11fe3b80c3d86a8281&=&format=webp&quality=lossless",
            //polygons
        ...
        function convertReversedBinaryToUsefulStuff(reversedBinaryArray) {
            ...
            for (let k = 0; k < reversedBinaryArray.length; k++) {
                ...
                // Check if the element is a string and equal to "Undiscovered"
                if (typeof reversedBinaryString === 'string' && reversedBinaryString === "Undiscovered") {
                    continue; // Skip to the next element
                }
                // Convert the reversed binary string to useful numbers
                let usefulNumbers = [];
                let i = 0;
